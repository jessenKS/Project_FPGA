...
HD_PWD='C:/Users/Jessen/Desktop/Jessen_Aula/Microcontroladores 2/Project_FPGA/Project_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_fpga_code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_fpga_code.tcl
