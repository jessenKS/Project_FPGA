...
HD_PWD='C:/Users/Jessen/Desktop/Jessen_Aula/Microcontroladores 2/Project_FPGA/Project_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_fpga_code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_fpga_code.tcl -notrace
